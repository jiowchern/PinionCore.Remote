...
namespace PinionCore.Network
{
    ...
    public interface IStreamable : System.IDisposable
    {
        ...
        IAwaitableSource<int> Receive(byte[] buffer, int offset, int count, CancellationToken token);
        /// <summary>
        ///     Send data streams.
        /// </summary>
        /// <param name="buffer">Stream instance.</param>
        ...
        IAwaitableSource<int> Send(byte[] buffer, int offset, int count, CancellationToken token);
    }
}
