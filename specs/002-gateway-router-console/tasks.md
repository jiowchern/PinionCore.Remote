...
- [ ] T032 [US2] 實作 AgentWorker 啟動 (持續處理 registry.Agent.HandlePackets/HandleMessage)
- [ ] T033 [US2] 在 Router 端添加 Registry 連接日誌 (使用 Log.WriteInfo 記錄連線建立與 Group ID，FR-018)
- [ ] T034 [US2] 實作 Registry 斷線偵測與日誌記錄 (Router 端，FR-018)
