...
namespace PinionCore.Remote
{
    ...
    /*public class SoulProvider2 : IDisposable, IBinder
    {
        ...
        private void _InvokeEvent(long entity_id, int event_id, long handler_id, object[] args)
        {
            ...
            PinionCore.Remote.Packages.PackageInvokeEvent package = new PinionCore.Remote.Packages.PackageInvokeEvent();
        ...
        private void _ReturnDataValue(long return_id, IValue return_value)
        {
            ...
            PinionCore.Remote.Packages.PackageReturnValue package = new PinionCore.Remote.Packages.PackageReturnValue();
        ...
        {
            PinionCore.Remote.Packages.PackageLoadSoulCompile package = new PinionCore.Remote.Packages.PackageLoadSoulCompile();
            package.EntityId = id;
        ...
        private void _LoadProperty(long id, int property , object val)
        {
            ...
            PinionCore.Remote.Packages.PackageSetProperty package = new PinionCore.Remote.Packages.PackageSetProperty();
            package.EntityId = id;
        ...
        {
            PinionCore.Remote.Packages.PackageLoadSoul package = new PinionCore.Remote.Packages.PackageLoadSoul();
            package.TypeId = type_id;
            package.EntityId = id;
        ...
        private void _UnloadSoul(int type_id, long id)
        {
            ...
            PinionCore.Remote.Packages.PackageUnloadSoul package = new PinionCore.Remote.Packages.PackageUnloadSoul();            
            package.EntityId = id;
        ...
        {
            PinionCore.Remote.Packages.PackageErrorMethod package = new PinionCore.Remote.Packages.PackageErrorMethod();
        ...
        private SoulProxy _NewSoul(object soul, Type soul_type)
        {
            ...
            PinionCore.Utility.Log.Instance.WriteInfo($"soul add {newSoul.Id}:{soul_type.Name}.");
        ...
        private SoulProxy _Bind(object soul, Type soul_type, bool return_type, long return_id)
        {
            ...
            //PinionCore.Utility.Log.Instance.WriteInfoNoDelay($"bind i:{soul.GetHashCode()} t:{soul_type} id:{newSoul.Id}");
            return newSoul;
        }
        ...
        private void _Unbind(ISoul soul)
        {
            ...
            SoulProxy soulInfo;
            //PinionCore.Utility.Log.Instance.WriteInfoImmediate($"unbind i:{soul.Instance.GetHashCode()} t:{soul.Instance.GetType()} id:{soul.Id}.");
        ...
        private void _PropertyUnbind(long soul_id, int property_id, long property_soul_id)
        {
            ...
            PinionCore.Remote.Packages.PackagePropertySoul package = new PinionCore.Remote.Packages.PackagePropertySoul();
