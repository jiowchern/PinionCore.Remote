...
namespace PinionCore.Serialization.Tests
{
    public class VarintTests
    {
        ...
        public void FindVarintTest()
        {
            ...
            ArraySegment<byte> varint = Varint.FindVarint(ref seg);
        ...
        public void FindPackagesTest()
        {
            ...
            Varint.Package[] varintPairs = Varint.FindPackages(seg).ToArray();
        ...
        public void FindPackagesTest2()
        {
            ...
            var seg = new ArraySegment<byte>(buffer, 0, buffer.Length);
            System.Collections.Generic.IEnumerable<Varint.Package> varintPairs = Varint.FindPackages(seg);
