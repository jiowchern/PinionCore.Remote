    ...
    public class GhostResponseHandlerTests
    {
        ...
        class GhostIA : IA, IGhost
        {
            ...
            event Action<int> IA.Event1
            {
                add
                {
                    _PinionCore_Remote_Tests_GhostResponseHandlerTests_IA_Event1.Add(value);
                }
            ...
            private readonly Notifier<IA> _PinionCore_Remote_Tests_GhostResponseHandlerTests_IA_Property2 = new Notifier<IA>();
            Notifier<IA> IA.Property2 => _PinionCore_Remote_Tests_GhostResponseHandlerTests_IA_Property2;
